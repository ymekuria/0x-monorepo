...
library LibMetaTransactionsRichErrors {
    ...
    {
        return abi.encodeWithSelector(
            bytes4(keccak256("MetaTransactionAlreadyExecutedError(bytes32)")),
            mtxHash
        );
    }

    function UnsupportedMetaTransactionFunctionError(
        bytes32 mtxHash,
        bytes4 selector
    )
        internal
    ...
    {
        return abi.encodeWithSelector(
            bytes4(keccak256("UnsupportedMetaTransactionFunctionError(bytes32,bytes4)")),
            mtxHash,
            selector
        );
    }
    ...
    {
        return abi.encodeWithSelector(
            bytes4(keccak256("MetaTransactionInvalidSignatureError(bytes32,bytes)")),
            mtxHash,
            signature
        );
    }
